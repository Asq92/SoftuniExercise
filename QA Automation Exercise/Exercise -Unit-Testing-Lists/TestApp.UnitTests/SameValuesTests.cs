...
public class SameValuesTests
{
    ...
    {
        //Arrange
        List<int> firstList = new List<int> { 2, 3, 4 };
        List<int> secondList = new List<int> { 1, 5, 6 };
    ...
    {
        //Arrange
        List<int> firstList = new List<int> { 1, 2, 3, 5, 6 };
        List<int> secondList = new List<int> { 1, 2, 3, 9, 10 };
